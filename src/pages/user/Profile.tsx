  ...
  const handleFullNameChange = () => {
    ...
    if (trimmedFullName) {
      if (trimmedFullName.length < 3 || trimmedFullName.length > 30) {
        setFullNameError(
          "Fullname should be having greater than 2 characters and less than 30 characters"
        );
        return;
      } else {
        const response = instance.put(
          `/user/api/v1/edit-fullName?fullName=${fullName}`
        );
        response
          .then((result) => {
            dispatch(fetchUserData());
          ...
          <div>
            ...
            <div className="py-10">
              ...
              <p className="text-black pt-3">
                To help us locate you and find workers in your area, your
                address is required.
              </p>
              {user?.address ? (
                <div className="pt-16">
                  <p className="text-black font-semibold">
                    Address You have added
                  </p>
