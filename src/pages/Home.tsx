            ...
            <div className="flex">
              <div className="">
                ...
                <p className="text-black text-sm px-10 mt-4">
                  Find reliable blue-collar workers for your home projects.
                  Browse profiles and book skilled professionals hassle-free.
                </p>
                <div
              ...
              <img
                className="w-[350px] hidden md:block h-[260px] mt-[30px]"
                src={client}
              />
            </div>
          </div>
          <div
            className="bg-[rgb(115,170,215)] h-[290px]  rounded-xl hover:shadow-lg hover:scale-105 duration-300"
            ...
            <div className="flex">
              <div className="">
                ...
                <p className="text-black text-sm md:ps-14 px-10 mt-4">
                  Ready to showcase your skills? Join us as a worker. Register
                  now for new opportunities and steady income..
                </p>
              ...
              <img
                className="md:w-[320px] hidden md:block md:h-[200px] mt-[90px]"
                src={image}
              />
            </div>
          </div>
