...
const LoginInfo = () => {
  ...
  return (
    <div>
      <div className="pt-20">
        <p className="text-black font-semibold text-lg">Basic Information</p>
      ...
      <div className="flex pt-10 gap-20">
        <div>
          ...
          <p className="mt-2">Manage your password to make sure it is safe</p>
        </div>
        <form onSubmit={handleChangePassword}>
          <div className="px-28">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-yellow-500 hover:rounded-3xl duration-300 text-white px-5 py-3 rounded-xl"
              >
                Change Password
              </button>
            </div>
