...
const About = () => {
    return (
      <div>
        <div className="flex w-full py-10 bg-gray-100 md:pt-28 px-16 gap-10" data-aos="fade-right">
        ...
        <div className="flex bg-gray-100 pb-20 gap-32 px-16" data-aos="fade-left">
